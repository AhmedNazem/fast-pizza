      ...
      <ul className=" divide-y divide-stone-200  border-b border-t">
        {cart.map((item) => (
          <OrderItem
            ...
            //* inside the fetcher we got all  the data for the pizza so now we want to fetch the specific data for the users pizza in the order that cause better UX experience
            ingredients={
